...
- An in-course mastery/review prerequisite map exposes mastered, practiced, struggling, ready, blocked, and due concepts; true prerequisite branches and merges; confidence/correctness mismatches; recent route history; and reviewed review actions without streaks, points, badges, confetti, or punitive wording. It is a read-only React Flow graph: solid links express prerequisites, subtle dashed links provide course-sequence orientation only where no prerequisite link exists, and selecting a node progressively reveals its evidence and valid actions.
