...
- The Teacher Command Center extends the logo palette beyond controls into a restrained professional surface hierarchy. Its evidence brief carries a narrow orange/clay/warm-grey signature and subtle clay wash; the two operating panels use distinct orange and brown identities with soft coordinated headers and metric tiles; suggested commands rotate through low-intensity palette tints; and portfolio course covers use stronger geometric orange/clay/brown/grey fields. The canvas and primary reading surfaces remain light, and instructional graphs retain their intentional multicolor semantic exception.
