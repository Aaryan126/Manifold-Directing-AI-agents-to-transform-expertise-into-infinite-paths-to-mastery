...
| Interaction motion | **Motion for React** | Shared-layout projection powers the instructor and learner assistant capsule-to-dock transition with maintained layout measurement, spring motion, presence handling, and user reduced-motion support instead of a bespoke FLIP implementation. |
