            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "routable concepts per topic. Every supplied topic UUID must appear in "
                        "at least one concept's topic_ids using the exact UUID supplied. Before "
                        "returning, verify that coverage explicitly. For a segment mixing "
                        "orientation or logistics with instruction, extract only a transferable "
                        "principle, case framework, or decision model that is clearly supported "
                        "by its summary; never invent a concept merely to satisfy coverage. "
                        "Prefer one concept spanning multiple topics "
