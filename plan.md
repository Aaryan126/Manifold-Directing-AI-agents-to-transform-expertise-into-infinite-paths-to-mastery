...
- Render the instructor navigation rail in Manifold orange across expanded, collapsed, and mobile-bottom-navigation states, with dark-ink controls, a translucent cream active/hover treatment, and a cream identity chip that retain accessible contrast. Learner-insight speech bubbles in `Needs your judgment` use orange line art without a filled icon tile.
