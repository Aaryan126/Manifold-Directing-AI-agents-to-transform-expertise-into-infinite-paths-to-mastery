...
- Enrich the Teacher Command Center with a professional orange/clay/brown/warm-grey surface system while retaining the light canvas: use a restrained palette signature on the evidence brief, distinct orange and brown operating-panel identities, coordinated soft command and metric tints, and stronger palette-based geometric course-cover fields. Dense instructional graphs retain their separate multicolor semantic system.
