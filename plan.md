...
- Frontend unit/integration tests for complete typed graph construction, saved-position layout, initial fit-to-view, mode switching, topic focus, outline/canvas parity, node movement, inspector editing, relationship manipulation, proposal review, learner-path and revision overlays, and empty/loading/error states.
