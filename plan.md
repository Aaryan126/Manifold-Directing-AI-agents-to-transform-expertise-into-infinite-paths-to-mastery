...
**Deliverables:**
- Replace the separate published Overview and Course Map destinations with one detailed free-form Blueprint workspace and four synchronized modes: **Live** for evidence and priorities, **Design** for direct private editing, **Learner path** for cohort/learner sequence context, and **Revision** for live-versus-working state. Retain Assessments, Preview, and Settings as focused bulk/deep editors reachable from Blueprint.
...
- Add a synchronized inspector for topic/concept/clip/question/source/relationship records. In **Design** mode instructors can update inspector fields, connect or reconnect prerequisites, reposition artifacts, and change course sequence through direct or accessible controls. AI-authored changes remain typed proposals with `Accept AI suggestion / Edit manually / Dismiss`; direct teacher edits remain audited and open a private working revision on first save.
...
- Frontend unit/integration tests for complete typed graph construction, artifact-to-node/port mapping, core/all/contextual relation visibility, ELK bend-point consumption, deterministic semantic ordering, saved-position layout, initial fit-to-view, mode switching, topic focus, outline/canvas parity, node movement, inspector editing, relationship manipulation, proposal review, learner-path and revision overlays, and empty/loading/error states.
...
**Human test checklist:**
- [ ] Open a realistic published course and move between Live, Design, Learner path, and Revision without losing the selected topic/concept; confirm the graph makes clips, questions, sources, sequence, evidence, and routing feel like parts of one course system rather than separate tools.
...
- [ ] In Design mode, drag a node and confirm its position persists after reload. Use the accessible nudge and sequence controls and confirm they update the same private working revision while the published learner path remains unchanged.
