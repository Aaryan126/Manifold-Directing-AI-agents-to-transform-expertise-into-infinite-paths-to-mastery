...
- [ ] In the whole-course Blueprint, confirm the complete graph fits into view on first load; then use topic focus, `Jump to` selection, pan/zoom, and saved positions to inspect a dense course without losing context.
